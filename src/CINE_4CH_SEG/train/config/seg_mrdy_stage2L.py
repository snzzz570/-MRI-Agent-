...
data = dict(
    ...
    train=dict(
        ...
        dst_list_file='/home/qutaiping/nas/processed_data/processed_4CH_dy_stage2_L/train.lst',
        data_root="/home/qutaiping/nas/processed_data/processed_4CH_dy_stage2_L",
...
work_dir = '/home/qutaiping/nas/checkpoints/4CH_dy_second2_L'
...
load_from = '/home/qutaiping/nas/checkpoints/4CH_dy_second2_L/latest.pth'
workflow = [('train', 1)]
